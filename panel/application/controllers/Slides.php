...
class Slides extends CI_Controller
{
    ...
    public function update($id){
        ...
        if($validate){
            ...
            $update = $this->slide_m->update(array("id" => $id), $data);
            ...
            $viewData->item = $this->slide_m->get(
                array(
                    "id"    => $id,
                )
            );
