<section class="light-gray-bg pv-40 border-clear">
    <div class="container">
        ...
        <!-- page-title start -->
        <!-- ================ -->
        <h1 class="page-title text-center">Dökümanlar</h1>
                ...
                <div class="image-box style-2 mb-20">
                    <div class="overlay-container overlay-visible">
                        ...
                        <div class="overlay-bottom">
                            <div class="text">
                                <p class="lead margin-clear text-left mobile-visible">Bir</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-4">
                <div class="image-box style-2 mb-20">
                    <div class="overlay-container overlay-visible">
                        ...
                        <div class="overlay-bottom">
                            <div class="text">
                                <p class="lead margin-clear text-left mobile-visible">İki</p>
                            </div>
                        </div>
                    </div>
                    <div class="body padding-horizontal-clear">
            ...
            <div class="col-md-4">
                <div class="image-box style-2 mb-20">
                    <div class="overlay-container overlay-visible">
                        ...
                        <div class="overlay-bottom">
                            <div class="text">
                                <p class="lead margin-clear text-left mobile-visible">Üç</p>
                            </div>
                        </div>
                    </div>
                    <div class="body padding-horizontal-clear">
