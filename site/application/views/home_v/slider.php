            ...
            <ul class="slides">
                ...
                <?php foreach ($slides as $slide) { ?>
                    ...
                    <li data-transition="fadefromright" data-slotamount="default" data-masterspeed="default"
                        data-title="We Can Build Anything">

                        <!-- main image -->
                        <img src="<?php echo get_picture("slides_v", $slide->img_url, "1920x650"); ?>" alt="slidebg1"
                        ...
                        <div class="tp-caption dark-translucent-bg caption-box text-left hidden-sm-down"
                            ...
                            <?php if ($slide->allowButton) { ?>
                                <div class="text-right">
                                    <a class="btn btn-small btn-gray-transparent margin-clear" href="<?php echo $slide->button_url; ?>">
