        ...
        <div class="row">
            ...
            <div class="main col-lg-8 space-bottom">
                ...
                <div class="contact-form">
                    <form id="" class="margin-clear" action="<?php echo base_url("home/do_login");?>" method="post">
                        ...
                        <input type="submit" value="Giriş yap" class="submit-button btn btn-default">
                        <a href="<?php echo base_url("kayit-ol"); ?>" class="pull-right btn btn-danger btn-md btn-outline">Kayıt ol</a>
                    </form>
                </div>
            </div>
            <!-- main end -->
